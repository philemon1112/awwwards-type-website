    ...
    return (
        <div id="contact" className='my-20 min-h-96 w-screen px-10'>
            <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
                <div className="absolute -left-20 top-0 hidden md:block h-full w-72 overflow-hidden lg:left-20 lg:w-96">
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="special-font mt-10 w-full font-sentry text-5xl leading-[0.9] md:text-[6rem]">
